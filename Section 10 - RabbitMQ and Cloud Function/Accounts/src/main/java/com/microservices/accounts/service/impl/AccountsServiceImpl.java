...
public class AccountsServiceImpl  implements IAccountsService {
    ...
    private void sendCommunication(Accounts savedAccount, Customer savedCustomer) {
        var accountsMsgDto = new AccountsMsgDTO(savedAccount.getAccountNumber(), savedCustomer.getName(),
                savedCustomer.getEmail(), savedCustomer.getMobileNumber());
        log.info("Sending communication details: {}", accountsMsgDto);
        boolean result = streamBridge.send("sendCommunication-out-0", accountsMsgDto);
        log.info("Sent Communication details: {}", result);
    }
